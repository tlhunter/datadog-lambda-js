...
export function extractTraceContext(
  ...
  // Use this object in the future to add tags to root span generated by the XRay Converter
  addMetadataToXray({
    [xrayMergeDatadogXrayTracesKey]: mergeDatadogXrayTraces,
  });

  if (trace !== undefined) {
    try {
      addXrayMetadata(xraySubsegmentKey, getTraceContext(trace));
...
export function addMetadataToXray(metadata: Record<string, any>) {
  addXrayMetadata(xrayBaggageSubsegmentKey, metadata);
}
